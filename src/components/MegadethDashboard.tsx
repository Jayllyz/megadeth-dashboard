...
export default function MegadethDashboard({
	artistInfo,
	topTracks,
	albums,
}: MegadethDashboardProps) {
			...
			<div className="max-w-6xl mx-auto space-y-8">
						...
						<div className="flex flex-col md:flex-row items-center gap-8">
							...
							<div className="space-y-4">
								...
								<p className="text-xl text-muted-foreground">
									Megadeth is an iconic American heavy metal band formed in
									1983. Known for their technical prowess and politically
									charged lyrics, they've been a pivotal force in the thrash
				...
				<Card className="bg-card text-card-foreground">
					<CardHeader>
						...
						<CardDescription>
							Popularity of Megadeth's top 10 tracks
						</CardDescription>
					</CardHeader>
					<CardContent>
						...
						<ScrollArea className="h-[400px] w-full rounded-md border border-border p-4">
							{albums?.items.map((album: AlbumSimplified, i: number) => (
								<div key={album.id}>
									...
									{albums && i !== albums.items.length - 1 && (
